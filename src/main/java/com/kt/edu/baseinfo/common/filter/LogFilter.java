...
import com.kt.edu.baseinfo.common.wrapper.RequestBodyTransformWrapper;
...
public class LogFilter implements Filter {
    ...
    public void doFilter(
        ...
        if (req.getMethod().equals("POST")){
            ...
            //LogUtil.info("[CTG:CMMN]{}", messageBody);
        }
        try {
            //chain.doFilter(req, response);
            RequestBodyTransformWrapper requestWrapper = new RequestBodyTransformWrapper(multiReadRequest);
