package com.kt.edu.baseinfo.common.aop;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.kt.edu.baseinfo.employee..*(..))") // (4)
    public void all() {
    }

    @Pointcut("execution(* com.kt.edu.baseinfo.employee.*Controller.*(..))") // (5)
    public void controller() {
    }

    @Pointcut("execution(* com.kt.edu.baseinfo.employee..*Service.*(..))") // (6)
    public void service() {
    }
    ...
    @Before("@annotation(com.kt.edu.baseinfo.common.annotation.Ktedu)")
